...
*add cost values to graph
\begin{figure}[ht]
    \centering
    \includegraphics[width=2.5in]{Figures/svm.00001.png}
    \includegraphics[width=2.5in]{Figures/svm.001.png} \\
    \includegraphics[width=2.5in]{Figures/svm1.png}
    \includegraphics[width=2.5in]{Figures/svm1000.png} \\
    \includegraphics[width=2.5in]{Figures/svm100000.png}
    \includegraphics[width=2.5in]{Figures/svm1000000.png}
...
The code produces the graphs in Figure ~\ref{fig_svm_diff_gammas}.
*add gamma values to graph
\begin{figure}[ht]
    \centering
    \includegraphics[width=2.5in]{Figures/svmfit.01g.png}
    \includegraphics[width=2.5in]{Figures/svmfit.1g.png} \\
    \includegraphics[width=2.5in]{Figures/svmfit1g.png}
    \includegraphics[width=2.5in]{Figures/svmfit10g.png} \\
    \includegraphics[width=2.5in]{Figures/svmfit100g.png}
    \includegraphics[width=2.5in]{Figures/svmfit1000g.png}
    \caption{Experimentation with Different Gammas in Non-Linear Data}
    \label{fig_svm_diff_gammas}
\end{figure}

Using the tuning parameter, we can determine the best values for the cost and gamma parameters.
