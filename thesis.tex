...
\begin{figure}[H]
    \centering
    \includegraphics[width=2.5in]{Figures/penguins/cl_cd.png}
    \includegraphics[width=2.5in]{Figures/penguins/cl_fl.png} \\
    \includegraphics[width=2.5in]{Figures/penguins/cl_bm.png}
    \includegraphics[width=2.5in]{Figures/penguins/cd_fl.png} \\
    \includegraphics[width=2.5in]{Figures/penguins/cd_bm.png}
