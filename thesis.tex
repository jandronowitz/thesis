...
\begin{figure}[h]
    \centering
    \includegraphics[height=2in,natheight=480,natwidth=1400]{Figures/clustering_v_association.png}
...
\[ \min ||\beta|| \text{ subject to }
    \begin{cases}
        &y_i(x_i^T\beta + \beta_0) \ge 1 - \epsilon_i \forall i, \\ & \epsilon_i \ge 0, \sum \epsilon_i \le C, C \in \R 
    \end{cases}
\]
