...
\begin{figure}[ht]
    ...
    \begin{align*}
    & C=0.00001 & C=0.001 \\
    & \includegraphics[width=3in]{Figures/svm.00001.png} &
    \includegraphics[width=3in]{Figures/svm.001.png} \\
    & C=1 & C=1000 \\
    & \includegraphics[width=3in]{Figures/svm1.png} &
    \includegraphics[width=3in]{Figures/svm1000.png} \\
    & C=100000 & C=10000000 \\
    & \includegraphics[width=3in]{Figures/svm100000.png} &
    \includegraphics[width=3in]{Figures/svm1000000.png}
    \end{align*}
...
\begin{figure}[ht]
    ...
    & \includegraphics[width=3in]{Figures/svmfit.01g.png} &
    \includegraphics[width=3in]{Figures/svmfit.1g.png} \\
    & \gamma=1 & \gamma=10 \\
    & \includegraphics[width=3in]{Figures/svmfit1g.png} &
    \includegraphics[width=3in]{Figures/svmfit10g.png} \\
    & \gamma=100 & \gamma=1000 \\
    & \includegraphics[width=3in]{Figures/svmfit100g.png} &
    \includegraphics[width=3in]{Figures/svmfit1000g.png}
    \end{align*}
...
\begin{figure}
    \centering
    \includegraphics[width=5in]{Figures/svm_final_model.png}
...
\begin{figure}[ht]
    ...
    \caption{df.info() and df.isna().sum()}
...
From Figure ~\ref{fig_df.head()}, we can see the general structure of the dataset. In Figure ~\ref{fig_df.info()_df.isna().sum()}, \textbf{df.info()} tells us the name, length, and type of each variable and \textbf{df.isna().sum()} tells us how many missing values are in each variable. Figure ~\ref{fig_rstr(df)} shows us the unique values for each variable, which is useful in finding the species names. They are Adelie, Chinstrap, and Gentoo. Figure ~\ref{fig_df.describe()} describes the basic statistics for the numerical predictors. We see that the data looks clean with no outliers.

\subsection{CLEANING THE DATA}

We first want to drop the missing values. This can be acheived with
...
The associated plots are located in Figure ~\ref{fig_penguins_raw_data_plots}.

\begin{figure}
    \centering
    \includegraphics[width=1.5in]{Figures/penguins/cl_cd.png}
    \includegraphics[width=1.5in]{Figures/penguins/cl_fl.png}
    \includegraphics[width=1.5in]{Figures/penguins/cl_bm.png} \\
    \includegraphics[width=1.5in]{Figures/penguins/cd_fl.png}
    \includegraphics[width=1.5in]{Figures/penguins/cd_bm.png}
    \includegraphics[width=1.5in]{Figures/penguins/fl_bm.png}
    \caption{Raw Data Points of the Penguins Dataset}
    \label{fig_penguins_raw_data_plots}
\end{figure}
