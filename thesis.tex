...
\begin{figure}[ht]
    ...
    & \includegraphics[width=2.4in]{Figures/svmfit.01g.png} &
    \includegraphics[width=2.4in]{Figures/svmfit.1g.png} \\
    & \gamma=1 & \gamma=10 \\
    & \includegraphics[width=2.4in]{Figures/svmfit1g.png} &
    \includegraphics[width=2.4in]{Figures/svmfit10g.png} \\
    & \gamma=100 & \gamma=1000 \\
    & \includegraphics[width=2.4in]{Figures/svmfit100g.png} &
    \includegraphics[width=2.4in]{Figures/svmfit1000g.png}
    \end{align*}
