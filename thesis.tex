...
\begin{table}[h]
    \centering
    \begin{tabular}{p{1.6cm}p{1.6cm}p{1.6cm}p{1.6cm}p{1.7cm}p{1.7cm}p{1.7cm}}
...
\begin{figure}
    \centering
    \includegraphics[width=5.5in]{Figures/fig05.png}
...
\begin{figure}
    \centering
    \includegraphics[width=5.5in]{Figures/fig06.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=5in]{Figures/svmfitoutput.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=5in]{Figures/fig08.png}
